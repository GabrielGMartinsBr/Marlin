...
#define STRING_CONFIG_H_AUTHOR "(GabrielGMartins, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Corezinha"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.70, 79.70, 396.0396, 103.09 }
